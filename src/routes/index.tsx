    ...
    <header className="fixed top-0 inset-x-0 z-50">
      <div className="mx-auto max-w-6xl px-6 mt-4">
        <div className="glass rounded-full flex items-center justify-between px-5 py-2.5">
          ...
          <button className="text-sm bg-primary text-primary-foreground rounded-full px-4 py-1.5 font-medium hover:opacity-90 transition flex items-center gap-1">
  ...
  return (
    <section className="relative pt-40 pb-20 px-6 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          <button className="bg-primary text-primary-foreground rounded-full px-6 py-3 font-medium glow-primary hover:scale-[1.02] transition">
            Open the canvas
          </button>
    ...
    <section className="px-6 py-24" id="pricing">
      <div className="mx-auto max-w-4xl glass rounded-3xl p-12 text-center relative overflow-hidden">
        ...
        <div className="relative mt-8 flex justify-center gap-3">
          <button className="bg-primary text-primary-foreground rounded-full px-7 py-3 font-medium glow-primary">
            Start building
          </button>
